...
public class jdManTipoServicio extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Gestionar Tipo de Servico");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            if (txtCodigo.getText().isEmpty()) {
                ...
                rsTH = objTS.buscarTS(Integer.parseInt(txtCodigo.getText()));
                if (rsTH.next()) {
                    txtNombre.setText(rsTH.getString("nombre"));
                    txtCosto.setText(String.valueOf(rsTH.getDouble("costobase")));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // TODO add your handling code here:
        try {
            objTS.modificarTS(Integer.parseInt(txtCodigo.getText()), txtNombre.getText(), chkVigencia.isSelected(), Double.parseDouble(txtCosto.getText()));
            limpiarControles();
    ...
    private Boolean verificarCampos() {
        if (txtCodigo.getText().isEmpty() || txtCosto.getText().isEmpty() || txtNombre.getText().isEmpty()) {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        try {
            if (btnNuevo.getText().equals("Nuevo")) {
                ...
                txtCodigo.setText(objTS.generarCodigoTS().toString());
                txtNombre.requestFocus();
            } else {

                //Guardar 
                if (verificarCampos()) {
                    objTS.registrarTS(Integer.parseInt(txtCodigo.getText()), txtNombre.getText(), chkVigencia.isSelected(), Double.parseDouble(txtCosto.getText()));
                    btnNuevo.setText("Nuevo");
                    limpiarControles();
                }
    ...
    private void btnDarDeBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDarDeBajaActionPerformed
        ...
        try {
            if (!txtCodigo.getText().isEmpty()) {
                objTS.darBajarTS(Integer.parseInt(txtCodigo.getText()));
                limpiarControles();
        ...
        try {
            ...
            while (rsListaTS.next()) {
                ...
                modelo.addRow(new Object[]{
                    rsListaTS.getInt("codtiposer"),
                    rsListaTS.getString("nombre"),
                    rsListaTS.getDouble("costobase"),
                    vigencia
                });
    ...
    private void txtCostoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCostoKeyTyped
        ...
        if (((caracter < '0') || (caracter > '9')) && (caracter != '.' || txtCosto.getText().contains("."))) {
            evt.consume();
